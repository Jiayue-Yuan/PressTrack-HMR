...
from .footprint_tracker import FootprintTracker

# A mapping of tracker types to corresponding tracker classes
TRACKER_MAP = {"bytetrack": BYTETracker, "botsort": BOTSORT, 'footprint': FootprintTracker}
...
def on_predict_start(predictor: object, persist: bool = False) -> None:
    ...
    if cfg.tracker_type not in {"bytetrack", "botsort", "footprint"}:
        raise AssertionError(f"Only 'footprinttrack', 'bytetrack' and 'botsort' are supported for now, but got '{cfg.tracker_type}'")
