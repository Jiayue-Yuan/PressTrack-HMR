...
def NoteGeneration(args):
    ...
    temp_encoder = '_' + args.temp_encoder
    ...
    weight = '_' + str(args.e_3d_loss_weight) + '_' + '_' + str(args.e_pose_loss_weight) + \
             '_' + str(args.e_shape_loss_weight) + '_' + str(args.e_trans_loss_weight)
