...
def main(args):
    ...
    logging_path = os.path.join(args.logging_path, 'test_tracked', NoteGeneration(args))
    checkpoints_path = os.path.join(args.checkpoints_path, 'test_tracked', NoteGeneration(args))
...
if __name__ == '__main__':
    ...
    args.seqlen = 16
    args.overlap = 0.95
    args.test_best_checkpoints = '/workspace/PressTrack-HMR/checkpoints/20250701/MPCarpet_unseen_group_resnet18_trans_spin_1e-06_16_16_0.9_768_1024/hps_42_losses_98.39.pth'
